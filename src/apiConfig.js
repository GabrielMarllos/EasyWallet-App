...
export const applicantsBaseUrl = `${baseUrl}api/v1/applicants`;
export const companiesBaseUrl = `${baseUrl}api/v1/companies`;
export const recruitersBaseUrl = `${baseUrl}api/v1/recruiters`;
export const jobPostsBaseUrl = `${baseUrl}api/v1/job-posts`;
export const recruitmentProcessesBaseUrl = `${baseUrl}api/v1/recruitment-processes`;
